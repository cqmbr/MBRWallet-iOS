...
- (void)setupView {
    ...
    NSString *locStr4 = @"切换账户";
    NSString *locStr5 = @"清除账户";
    ...
    UIButton *btn4 = [self btnWithImg:[UIImage imageNamed:@"create_white"] title:locStr4];
    UIButton *btn5 = [self btnWithImg:[UIImage imageNamed:@"import_white"] title:locStr5];
    [leftView addSubview:btn1];
    [leftView addSubview:btn2];
    [leftView addSubview:btn3];
    [leftView addSubview:btn4];
    [leftView addSubview:btn5];
    self.btns = [NSMutableArray array];
    [self.btns addObject:btn1];
    [self.btns addObject:btn2];
    [self.btns addObject:btn3];
    [self.btns addObject:btn4];
    [self.btns addObject:btn5];
    ...
    [btn4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.height.equalTo(btn1);
        make.top.equalTo(btn3.mas_bottom).offset(32);
    }];
    [btn5 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.height.equalTo(btn1);
        make.top.equalTo(btn4.mas_bottom).offset(32);
    }];
